...
interface PlayerAnimeCardProps {
    data: DataItem[] | null | undefined;
    id: string;
}

const PlayerAnimeCard: React.FC<PlayerAnimeCardProps> = ({ data, id }) => {
    const animetitle = useStore(useTitle, (state) => state.animetitle as string);
