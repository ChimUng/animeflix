...
function Catalog({ searchParams }: { searchParams: SearchParams }) {
  ...
  // Đồng bộ state với searchParams
    useEffect(() => {
        // console.log("🧾 [Catalog.tsx] searchParams nhận được:", searchParams);
    ...
    return (
            ...
            <>
                ...
                <div className={styles.genres}>
                    ...
                    <div className="relative w-full cursor-default overflow-hidden rounded-[0.6rem] text-left shadow-md focus:outline-none sm:text-sm">
                        ...
                        >
                            <path
                            fillRule="evenodd"
                            d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 0 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z"
                            clipRule="evenodd"
                            />
                        </svg>
                        </ComboboxButton>
                ...
                <div className={styles.catalogsort}>
                    ...
                    onSelectionChange={(keys) =>
                        setSortbyvalue((keys as { anchorKey?: string }).anchorKey || null)
                    }
                    >
                ...
                <div className={styles.yearmobil}>
                    ...
                    onSelectionChange={(keys) =>
                        setSelectedYear((keys as { anchorKey?: string }).anchorKey || null)
                    }
                    >
                ...
                <div className={styles.yearmobil}>
                    ...
                    onSelectionChange={(keys) =>
                        setFormatvalue((keys as { anchorKey?: string }).anchorKey || null)
                    }
                    >
                ...
                <div className={styles.yearmobil}>
                    ...
                    onSelectionChange={(keys) =>
                        setSeasonvalue((keys as { anchorKey?: string }).anchorKey || null)
                    }
                    >
        ...
        <div className={styles.catalogbottom}>
            ...
            <Searchcard
                ...
                airingvalue={null} // airingvalue chưa dùng*
            />
            </div>
        </div>
        </div>
