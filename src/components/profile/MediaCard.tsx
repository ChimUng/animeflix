        ...
        <div className='flex flex-col'>
            <div className='relative overflow-hidden rounded-lg shadow-lg group p-1 flex-shrink-0 cursor-pointer'>
                <Link href={`/anime/info/${anime?.id}`}>
                    ...
                    <div className="absolute inset-0 flex items-end group-hover:bg-gradient-to-t from-black/80 to-transparent"></div>
                    <span className="absolute bottom-2 group-hover:flex hidden justify-center w-full text-center text-[12px]">
                        Tập - {anime?.progress}/{anime?.media?.episodes || "?"}
                    </span>
                </Link>
